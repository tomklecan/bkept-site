...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* CALCULATOR MODULE */
        .calc-wrapper { background: #fff; border: 1px solid var(--bk-border); padding: 50px; box-shadow: 0 20px 40px rgba(0,0,0,0.05); margin-bottom: 100px; }
        ...
        /* OUTPUT BOARD */
        .output-board { background: #2D3436; color: #fff; padding: 40px; border-radius: 4px; display: grid; grid-template-columns: 1fr 1fr; gap: 40px; }
...
<body>
    ...
    <div class="container">
        <div class="page-hero">
            ...
            <p style="color: #636E72; max-width: 600px; margin: 0 auto;">Use the calculator below to estimate your investment. We do not hide behind "Call for Quote" buttons unless complexity demands it.</p>
        </div>
        ...
        <div class="calc-wrapper">
            ...
            <div class="slider-group">
                ...
                <input type="range" id="rangeTxn" min="0" max="600" step="50" value="100" oninput="calculate()">
            ...
            <div class="slider-group">
                ...
                <input type="range" id="rangeAccts" min="1" max="10" step="1" value="1" oninput="calculate()">
            </div>
            ...
            <div class="slider-group">
                ...
                <input type="range" id="rangeMonths" min="0" max="12" step="1" value="0" oninput="calculate()">
            </div>
            ...
            <div style="text-align: center; margin-top: 40px;">
                <a href="mailto:hello@bkept.co?subject=Proposal Request" class="back-link" style="background: var(--bk-dark); color: white; padding: 15px 30px; border-radius: 4px;">Initialize Proposal</a>
            </div>
    ...
    <script>
        function calculate() {
            ...
            // Prices
            if (txn >= 600) {
                document.getElementById('outRetainer').innerText = "Custom";
                document.getElementById('outCleanup').innerText = "Custom";
            } else {
                document.getElementById('outRetainer').innerText = "$" + monthlyTotal.toLocaleString();
                document.getElementById('outCleanup').innerText = "$" + totalCleanup.toLocaleString();
            }
